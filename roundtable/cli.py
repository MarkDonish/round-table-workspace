...
def build_launch_kit_payload() -> dict[str, object]:
    ...
    assets = [
        ...
        "docs/one-minute-demo-card.html",
        "docs/one-minute-demo-card.png",
        "docs/one-minute-demo.md",
        "docs/quick-evaluation.html",
        "docs/quick-evaluation.md",
        "docs/review-packet.html",
    ...
    return {
        ...
        "one_minute_demo_card": "https://markdonish.github.io/round-table-workspace/one-minute-demo-card.html",
        "one_minute_demo_card_image": "https://markdonish.github.io/round-table-workspace/one-minute-demo-card.png",
        ...
        "quick_evaluation_pages": "https://markdonish.github.io/round-table-workspace/quick-evaluation.html",
        "quick_evaluation": "https://github.com/MarkDonish/round-table-workspace/blob/main/docs/quick-evaluation.md",
        "review_packet_pages": "https://markdonish.github.io/round-table-workspace/review-packet.html",
        "review_packet": "https://github.com/MarkDonish/round-table-workspace/blob/main/docs/review-packet.md",
        "mechanism_guide": "https://github.com/MarkDonish/round-table-workspace/blob/main/docs/mechanism.md",
        "mechanism_page": "https://markdonish.github.io/round-table-workspace/mechanism.html",
        ...
        "contributor_starter_issues": "https://github.com/MarkDonish/round-table-workspace/blob/main/docs/contributor-starter-issues.md",
        ...
        "architecture_decision_transcript": "https://github.com/MarkDonish/round-table-workspace/blob/main/examples/transcripts/ship-check-architecture-decision.md",
...
def render_launch_kit_summary(payload: dict[str, object]) -> str:
    lines = [
        ...
        f"- Quick evaluation page: {payload.get('quick_evaluation_pages')}",
        f"- Quick evaluation path: {payload.get('quick_evaluation')}",
        f"- Review packet: {payload.get('review_packet_pages')}",
        f"- Review packet source: {payload.get('review_packet')}",
        f"- Mechanism guide: {payload.get('mechanism_guide')}",
        f"- Mechanism page: {payload.get('mechanism_page')}",
        ...
        f"- Contributor starter issues: {payload.get('contributor_starter_issues')}",
        ...
        f"- Architecture decision transcript: {payload.get('architecture_decision_transcript')}",
