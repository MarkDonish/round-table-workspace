...
- a real local agent host recipe source in `docs/local-agent-host-recipes.md`
...
- a checked-in release candidate report generator in `.codex/skills/room-skill/runtime/release_candidate_report.py`, with support-scope rules in `docs/release-candidate-scope.md`
