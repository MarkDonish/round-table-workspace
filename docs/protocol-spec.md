...
These fields define the current protocol surface. RTW-006 and RTW-007 will turn
the relevant subsets into JSON Schema files.
...
Future schema tasks should extend this document by linking:
