...
| Host adapter interface | Define shared capability validation, session preparation, turn execution, result collection, and evidence reporting methods | `roundtable_core/runtime/host_adapter.py` |
